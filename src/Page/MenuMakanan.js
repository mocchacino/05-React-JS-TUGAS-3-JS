...
class ManuMakanan extends Component{
    constructor(props){
        super(props)
        this.state = {
            pesan :0
    ...
    render(){
        return(
            <div>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <ListMakanan link="https://blog.tokowahab.com/wp-content/uploads/2020/03/Resep-Nasi-Kuning-Tumpeng-Mini.jpg "/>
                                <center>
                                    <button onClick={this.rubahPesanan}>Pesan Sekarang</button>
                                </center>
                            </td>
                ...
                <br/>
                <input type="text" placeholder="Masukan Pesanan.." onChange={this.pesanan}/>
